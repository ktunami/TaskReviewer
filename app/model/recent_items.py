...
class RecentItems(db.Model):
    ...
    long_tsk_id = db.Column(db.Integer)
    ...
    def __init__(self, name, content, is_content_link, remarks,
                 expected_days, create_date, start_time, end_time, lid=-1):
        self.name = name
